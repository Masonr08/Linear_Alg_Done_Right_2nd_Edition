---
title: "Section 1A Definitions (1.1 - 1.18)"
...
A *complex number* is an ordered pair $(a, b)$ where $a, b \in \mathbb{R}$, but we will write as $a + bi$.
...
$\mathbb{F}$ stands for either $\mathbb{R}$ or $\mathbb{C}$, and is called a *field*.
